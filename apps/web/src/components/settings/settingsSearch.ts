...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["installed cli versions newer available codex claude cursor grok opencode devin"],
  ...
  },
  {
    ...
    searchTerms: [
      "agents cli codex claude cursor grok opencode antigravity devin google sign in sign out install subscription instances authentication api key models configuration binary path config directory endpoint arguments environment variables display name accent color custom favorite hidden auto compact",
    ],
  },
  {
    id: "usage-providers",
